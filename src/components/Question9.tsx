...
const descriptions = [
  {
    name: 'foo',
    content: '母元件透過陣列產生 list 元素，key 屬性為該物件的 name 屬性',
  },
  {
    name: 'bar',
...
export default function Question9() {
  ...
  console.log('Question 9 answer:', answer);
  ...
  return (
    ...
    >
      <h2 className="col-span-3 text-left border-b">問題 9 - unique key</h2>
...
const Selection = React.memo(function Selection({
  ...
  counter += 1;
  console.log(`Question 9 Selection re-render ${counter}`);
